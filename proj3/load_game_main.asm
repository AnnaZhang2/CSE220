...
filename: .asciiz "C:/Users/heart/Documents/Work/School Work/Stony Brook University/Computer Science Courses/Systems Fundamentals I/game5.txt"  # you will likely need to put MARS into the same folder as this main file
